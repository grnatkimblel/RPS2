    ...
    return (
      <>
        ...
        <button
          ...
          onClick={() => setNextDisplayState("Online1")}
        >
          Online1
        </button>
        <button
          style={{ position: "absolute", marginLeft: "35rem", zIndex: "1" }}
          onClick={() => setNextDisplayState("Online2")}
        >
          Online2
        </button>
        ...
        <button
          ...
          onClick={() => setNextDisplayState("CreateAccount")}
        >
          CreateAccount
        </button>
      </>
      ...
      case "Local":
        return (
          <motion.div
            ...
            exit={nextDisplayState == "Online1" || nextDisplayState == "Online2" ? variants.up(5) : variants.right(3)}
          >
      ...
      case "Online1":
        return (
          <motion.div
            ...
            key="GameMenu"
            layoutId="OnlineMenu"
            initial={previousDisplayState.current == "Local" ? variants.down(3) : variants.right(3)}
            animate={variants.present}
            exit={nextDisplayState == "Local" ? variants.down(3) : variants.right(3)}
            className="purple"
          >
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <br />
          {"Last Display State: " + previousDisplayState.current}
        </motion.div>
...
function SlimTile({ key, position, color }) {
  return (
    <motion.div key={key} layout initial={position} animate={variants.present} exit={position}>
